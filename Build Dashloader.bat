...
CLS
COLOR 60
TITLE Build Gamers ( Dashloader Customizer Edits )
...
SET "DEST=BUILD Dashloader Customizer"
...
:COMPILE
  ...
  ECHO ------------------------------------------------------------
  Echo CStdString strOutPutPathHeaderFile("E:/TDATA/Rocky5 needs these Logs/Dashloader Customizer/");>"xbmc\lib\libPython\XBPyErrorPath.h"
  IF %Clean% EQU 1 (
...
:STOPTIME
  ...
  TITLE Build Gamers ( Dashloader Customizer Edits ) Build Time: %minutes% Mins %seconds% Secs
  GOTO:EOF
