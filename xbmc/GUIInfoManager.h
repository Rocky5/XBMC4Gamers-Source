...
#define LISTITEM_SYNOPSISALTNAME	       		(LISTITEM_START + 62)
#define LISTITEM_SYNOPSISOVERVIEW       		(LISTITEM_START + 63)
#define LISTITEM_SYNOPSISDEVELOPER      		(LISTITEM_START + 64)
#define LISTITEM_SYNOPSISPUBLISHER       		(LISTITEM_START + 65)
#define LISTITEM_SYNOPSISFEATURES_GENERAL       (LISTITEM_START + 66)
#define LISTITEM_SYNOPSISFEATURES_ONLINE        (LISTITEM_START + 67)
#define LISTITEM_SYNOPSISESRB      				(LISTITEM_START + 68)
#define LISTITEM_SYNOPSISESRB_DESCRIPTORS       (LISTITEM_START + 69)
#define LISTITEM_SYNOPSISGENRE      			(LISTITEM_START + 70)
#define LISTITEM_SYNOPSISRELEASE_DATE     		(LISTITEM_START + 71)
#define LISTITEM_SYNOPSISYEAR		     		(LISTITEM_START + 72)
#define LISTITEM_SYNOPSISRATING      			(LISTITEM_START + 73)
#define LISTITEM_SYNOPSISPLATFORM       		(LISTITEM_START + 74)
#define LISTITEM_SYNOPSISEXCLUSIVE       		(LISTITEM_START + 75)
#define LISTITEM_SYNOPSISTITLEID	       		(LISTITEM_START + 76)
#define LISTITEM_SYNOPSISFANART         		(LISTITEM_START + 77)
#define LISTITEM_SYNOPSISRESOURCES         		(LISTITEM_START + 78)
#define LISTITEM_SYNOPSISPREVIEW         		(LISTITEM_START + 79)
#define LISTITEM_SYNOPSISSCREENSHOT        		(LISTITEM_START + 80)
#define LISTITEM_SYNOPSISPLAYERCOUNT       		(LISTITEM_START + 81)
