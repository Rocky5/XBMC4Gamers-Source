...
enum CONTEXT_BUTTON { CONTEXT_BUTTON_CANCELLED = 0,
                      ...
                      CONTEXT_BUTTON_SYNOPSISUPDATE,
                      CONTEXT_BUTTON_SYNOPSISUPDATEALL,
					  CONTEXT_BUTTON_UNPATCHEDXBE,
                      ...
                      CONTEXT_BUTTON_LAUNCH_ALTXBE,
                      CONTEXT_BUTTON_TRAINERS,
                      CONTEXT_BUTTON_EDIT_REFRESH
                    };
